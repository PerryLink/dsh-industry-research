...
- DeepSeek Harness `dsh-v0.1.7-alpha.2` (npm प्रकाशित लाइन, 2026-09-18 को सत्यापित; peers `>=0.1.2-rc.1 <0.2.0 || >=0.1.5-alpha.1 <0.2.0 || >=0.1.6-0 <0.2.0 || >=0.1.7-0 <0.2.0` पर)।
...
`0.1.7-alpha.2` प्रकाशित peers के विरुद्ध 2026-09-18 को सत्यापित (पूर्ण गेट श्रृंखला; वास्तविक प्रोफ़ाइल इंस्टॉल स्मोक साप्ताहिक और प्रति-PR `compat.yml` जॉब चलाता है)।
