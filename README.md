...
- DeepSeek Harness `dsh-v0.1.7-rc.1` (published npm line, verified 2026-09-24; peers `>=0.1.2-rc.1 <0.2.0 || >=0.1.5-alpha.1 <0.2.0 || >=0.1.6-0 <0.2.0 || >=0.1.7-0 <0.2.0`).
...
Verified 2026-09-24 against the `0.1.7-rc.1` published peers (full gate chain; the real profile install smoke runs in the weekly and per-PR `compat.yml` job).
