...
- DeepSeek Harness `dsh-v0.1.7-alpha.2` (línea publicada en npm, verificado el 2026-09-18; peers en `>=0.1.2-rc.1 <0.2.0 || >=0.1.5-alpha.1 <0.2.0 || >=0.1.6-0 <0.2.0 || >=0.1.7-0 <0.2.0`).
...
Verificado el 2026-09-18 contra los peers publicados `0.1.7-alpha.2` (cadena de puertas completa; el smoke de instalación de perfil real lo ejecuta el job semanal y por PR `compat.yml`).
